...
namespace EasySave.ViewModel
{
    ...
    public partial class Extensionfiletocrypt : Window
    {
        ...
        private void filecrypt(object sender, RoutedEventArgs e)
        {
            ...
            if (langExt == "French")
            {
                Message.Text = "La liste ci-contre vous confirme ce que vous avez entré, vous pouvez revenir au menu si cela vous convient ou ajouter des enxtensions.";
            }

            else if (langExt == "English")
            {
                Message.Text = "List aside show you the extensions you enter, you can go back to the menu or change.";
            }

            File1_Copy.Text = FileType1;
        ...
        private void button2_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (langExt == "French")
            {
                Message2.Text = "La liste ci-dessus vous confirme ce que vous avez entré, vous pouvez revenir au menu si cela vous convient ou ajouter des enxtensions.";
            }

            else if (langExt == "English")
            {
                Message2.Text = "List above show you the extensions you enter, you can go back to the menu or change.";
            }

            File2_Copy.Text = FileType2;
